...
import { Eye, EyeOff, LayoutTemplate, Layers, Users } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-card flex-col justify-between p-12 overflow-hidden border-r border-white/5">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-secondary/20 blur-[150px] pointer-events-none" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-primary/20 blur-[150px] pointer-events-none" />
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="space-y-6 text-text/70">
            <div className="flex items-start gap-4">
              <LayoutTemplate className="w-6 h-6 text-accent shrink-0" />
              <div>
                <p className="font-medium text-text">Beautiful layouts</p>
                <p className="text-sm mt-1">Pre-built components designed by industry experts.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <Layers className="w-6 h-6 text-primary shrink-0" />
              <div>
                <p className="font-medium text-text">Scalable architecture</p>
                <p className="text-sm mt-1">Node.js, Express, and React working in perfect harmony.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <Users className="w-6 h-6 text-success shrink-0" />
              <div>
                <p className="font-medium text-text">Ready for your team</p>
                <p className="text-sm mt-1">Invite colleagues and manage roles effortlessly.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative overflow-hidden">
        ...
        <div className="lg:hidden absolute top-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-secondary/20 blur-[150px] pointer-events-none" />
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-text/60">Get started with SaaSBase today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <AppButton type="submit" loading={loading} className="w-full h-12 text-base mt-2">
              Create Account
            </AppButton>
          </form>
